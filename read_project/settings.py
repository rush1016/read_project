...
AUTH_USER_MODEL = 'read_app.Teacher'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = env("SMTP_EMAIL")  # Replace with your Gmail email
EMAIL_HOST_PASSWORD = env("SMTP_PASSWORD")     # Replace with your Gmail password
